...
import cv2
import numpy as np
from main_video import detect_face as df
from camera_capture import detect_face as cam
imagePath = ''
...
if __name__ == '__main__':
    ...
    # try: predict_gender('C:/Users/Omar Hassan/PycharmProjects/jupyter/001.JPG')

    try:
        imgpath = cam.capture(self=None)
        gender = predict_gender(imgpath)
    except:1
    # predict_gender(sys.argv[1] if len(sys.argv) > 1 else '.')
    print(f'image Path: {imgpath}')
    print(f'gender: {gender}')
    if gender == 'Male':
        df.load_encoding_images(self=None,images_path="D:/Backup/PycharmProjects/datasets/10photos/")
    elif gender == 'Female':
        df.load_encoding_images(self=None,images_path="D:/Backup/PycharmProjects/datasets/10photos/")

    # try: df.load_encoding_images(self=None,images_path="D:/Backup/PycharmProjects/datasets/10photos/")
    # df.load_encoding_images(self=None,images_path=imagePath)
    # except:print("Program Ended!")
