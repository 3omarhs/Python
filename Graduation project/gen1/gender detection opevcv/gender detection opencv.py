...
if __name__ == '__main__':
    ...
    predict_gender('C:/Users/Omar Hassan/PycharmProjects/jupyter/001.JPG')
    # predict_gender(sys.argv[1] if len(sys.argv) > 1 else '.')
    df = '../Graduation project/source code/main_video.py'
    df.load_encoding_images("D:/Backup/PycharmProjects/datasets/Celebrities photos/")
