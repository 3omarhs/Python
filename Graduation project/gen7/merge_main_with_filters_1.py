        ...
        while True:
            ...
            if run_fully:
                ...
                for face_loc, name in zip(face_locations, face_names):
                    ...
                    if gender == 'Male':
                        try:
                            filter.show_filter(filter2, eyes, faces, screen)
                ...
                if gender == 'Male':
                    ...
                    try:
                        frame = filter.show_filter(str(Male_list[filter3_m]), eyes, faces, screen)
                    except:
                        1
                else:
                    if keyboard.is_pressed('right'):
                    ...
                    try:
                        filter_w.show_filter(str(Female_list[filter3_f]), eyes, faces, screen)
                    except:
                        1
