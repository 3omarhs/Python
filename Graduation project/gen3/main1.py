...
class SimpleFacerec:
    ...
    def load_encoding_images(self, images_path, category):
        ...
        with open(f'encoded images files0/{category}_encoding.txt', "rb") as fp:  # Unpickling
        ...
        with open(f'encoded images files0/{category}_names.txt', "rb") as fp:  # Unpickling
    ...
    while True:
        ...
        for face_loc, name in zip(face_locations, face_names):
            ...
            if (name != 'Unknown'):
                ...
                try:
                    # img = cv2.imread(r"C:\Users\Omar Hassan\PycharmProjects\Graduation project\gen3\photos\mens\John_Bolton (6).png", cv2.IMREAD_UNCHANGED)
            ...
            # except:1
        cv2.waitKey(1)
        cv2.imshow("Barber Mirror Project by 3omar.hs..", imgBG)
