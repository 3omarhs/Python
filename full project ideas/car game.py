# check line 26, 32, 40 & correct the location...
...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('C:\\Users\\omarh\\Desktop\\sourceofcargame-main\\img\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('C:\\Users\\omarh\\Desktop\\sourceofcargame-main\\img\\enemy_car_1.png')
        ...
        # Background
        self.bgImg = pygame.image.load("C:\\Users\\omarh\\Desktop\\sourceofcargame-main\\img\\back_ground.jpg")
    ...
    def display_credit(self):
        ...
        text = font.render("all rights are saved to Randhir Kumar", True, self.white)
        self.gameDisplay.blit(text, (600, 520))
        text = font.render("copied by", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("3omar.hs", True, self.white)
