...
#  pip install git+https://github.com/pdhruv93/computer-vision/raw/main/fingers-count/__pycache__/handDetector.cpython-37.pyc
...
while True:
    status, image = webcamFeed.read()
    handLandmarks = handDetector.findHandLanpythondMarks(image=image, draw=True)
    count=0
